...
<jsp:useBean id="filmsForm" type="net.ehicks.cinemang.FilmsForm" scope="session"/>
<jsp:useBean id="filmSearchResult" type="net.ehicks.cinemang.FilmSearchResult" scope="session"/>
...
<head>
    ...
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/images/spaceCat.png">
    <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css'>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/styles/cinemang.css" media="screen" />

    <style>
        #ratingSlider { margin: 10px; }

        .ui-autocomplete-loading {
            background: white url("${pageContext.request.contextPath}/images/rolling.gif") right center no-repeat;
        }
                        ...
                        if(textStatus == "success")
                        {
                            ...
                            $.each(data, function(key, value){
                                ...
                                if (value.tomatoImage == 'fresh')
                                    freshImage = "<img src='${pageContext.request.contextPath}/images/certified_logo.png' style='vertical-align: middle' height='16px'/>";
...
<table style="margin: 0 auto; width: 100%; max-width: 1000px" class="list">
    <tr>
        <td style="width: 100%;">
            <h1 style="text-align: center;margin: 0;padding: 0;">CINEMANG <img src="${pageContext.request.contextPath}/images/spaceCat.png" style="height: 30px;vertical-align: middle"></h1>
        </td>
    </tr>
</table>
<br>
...
<table id="filmTable" style="margin: 0 auto" class="list">
    ...
    <tr class="listheading">
        ...
        <td class="sortableHeader alignright" onclick="sortFilms(this, 'cinemang_rating')">
            <img src="${pageContext.request.contextPath}/images/spaceCat.png" title="Cinemang Rating: Combines imdb Rating, Tomato Meter, and Tomato User Meter" style="height:24px;vertical-align: middle"/>
            <span>
        ...
        <td class="sortableHeader mediumPriority alignright" onclick="sortFilms(this, 'tomato_meter')">
            <img src="${pageContext.request.contextPath}/images/rottenTomatoes_logo.png" title="Tomato Meter" style="height:24px;vertical-align: middle"/>
            <span>
        ...
        <td class="sortableHeader mediumPriority alignright" onclick="sortFilms(this, 'tomato_user_meter')">
            <img src="${pageContext.request.contextPath}/images/rottenTomatoes_user_logo.png" title="Tomato User Meter" style="height:24px;vertical-align: middle"/>
            <span>
        ...
        <td class="sortableHeader mediumPriority alignright" onclick="sortFilms(this, 'imdb_rating')">
            <img src="${pageContext.request.contextPath}/images/imdb_logo.png" title="IMDb Rating" style="height:24px;vertical-align: middle"/>
            <span>
        ...
        <tr class="${rowStyle}">
            ...
            <td>
                <span onclick="toggleRow('${film.imdbID}')" style="color: blue; text-decoration: underline; cursor: pointer">
                    ...
                    ${filmTitle}
                    <c:if test="${film.tomatoImage=='fresh'}"><img src="${pageContext.request.contextPath}/images/certified_logo.png" style="vertical-align: middle" height="16px"/></c:if>
                </span>
            </td>
