...
//    }
//
//    public static void importFilmDataImdb()
//    {
//        try
//        {
...
//
//            File ratingsFile = getFtpFile(host, dir, login, "ratings.list.gz");
//            File releaseDatesFile = getFtpFile(host, dir, login, "release-dates.list.gz");
//            File languagesFile = getFtpFile(host, dir, login, "language.list.gz");
//            File genresFile = getFtpFile(host, dir, login, "genres.list.gz");
...
//
//            IOUtil.incorporateOmbdFile(ratingsFileFilms);
//
...
//    }
//
//    private static File getFtpFile(String host, String dir, String login, String remoteFilename) throws IOException
//    {
...
//    {
//        if (uniqueLanguages.size() == 0) uniqueLanguages = LanguageLoader.identifyUniqueLanguages(films);
