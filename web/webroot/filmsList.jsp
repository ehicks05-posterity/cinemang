...
<form name="frmFilter" method="post" action="?tab1=home&action=filterFilms">
    ...
    <table style="margin: 0 auto" class="list">
        <tr>
            ...
            <td><input id="title" name="title" type="text" size="32" maxlength="32" value="${sessionScope.title}"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <div id="ratingSlider" style="width: 200px"></div>
            </td>
        </tr>
...
<table style="margin: 0 auto" class="list">
    <tr class="listheading">
        <td><fmt:formatNumber value="${fn:length(films)}" pattern="#,###"/> Results</td>
